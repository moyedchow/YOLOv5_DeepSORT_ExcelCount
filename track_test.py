0# limit the number of cpus used by high performance libraries
import os
...
def count_obj(box,w,h,id,klass):
    k = klass().getklass()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes', default=[0,1], type=int, help='filter by class: --class 0, or --class 16 17')
